...
write.csv(STmodel_data,"./data/STmodel_data.csv", row.names = F)
write.csv(testset_shortterm,"./data/testset_shortterm.csv",row.names = F)
...
ggsave(file="./Plots/STplot_testset_det.png", plot=STplot_sample_week_test_full, width=12, height=8)
